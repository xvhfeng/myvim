...
# this script is use for init the vim context
# use this script,first install vim in your system(if you not install vim,you
# can exec vim_mac_installer.sh).
# if you use this script,then path tree is
# BASEDIR/{bundle/vundle,myvim}
# and cd to BASEDIR
