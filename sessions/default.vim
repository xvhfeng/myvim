...
map! <D-v> *
nnoremap o :TagbarToggle
nnoremap  :set paste
nnoremap <silent>  :call context#update('C-E')
nmap u gUiw
nmap i guiw
nmap 	 %
vmap 	 >gv
...
nmap o <Plug>ZoomWin
nnoremap <silent>  :BufExplorerVerticalSplit
nnoremap <silent> b :ToggleBufExplorer
nnoremap o :Unite  -start-insert -no-split outline
map  :Dox
map  
noremap z zf%
nnoremap <silent>  :call context#update('C-Y')
vmap  "+y
nmap   za
nnoremap <silent> # #zz
nnoremap ' `
...
nnoremap <silent> ,mm :Vifm
nnoremap <silent> ,nn :NnnPicker '%:p:h'
nnoremap <silent> ,n :NnnPicker
nmap ,C :ClangFormatAutoToggle
map ,es :FixWhitespace
nnoremap ,= :call IndentIgnoringComments()
map ,ch :call SetColorColumn(0)
noremap ,sd :call DeleteShiftLines()
noremap ,fr :call ReName()
noremap ,fd :call DeleteLines()
noremap ,fy :call CopyLinesToSystem()
noremap ,fc :cal ClearCurrentCursor()
noremap ,fg :call GetCurrentCursor()
nmap ,st :term
nmap ,vt :vert term
noremap <silent> ,/ :nohls
nmap <silent> ,p :set paste
...
nnoremap ga :Ack 
nmap gfa :CtrlSF =expand("<cword>") 
nmap gfw :CtrlSFQuickfix =expand("<cword>") 
nmap gw <Plug>(easymotion-overwin-w)
vmap gw <Plug>(easymotion-bd-w)
...
vmap gc <Plug>(easymotion-bd-f)
omap gc <Plug>(easymotion-bd-f)
nnoremap <silent> g* g*zz
nnoremap he :w!:A!
nmap ha :call SpxInsertHeadDefN()
map j gj
map k gk
nmap la :call GenFileRandom()
...
nnoremap <silent> zb zb:call context#update('zb')
nnoremap <silent> zz zz:call context#update('zz')
...
nnoremap <silent> <C-X><C-B> :BufExplorerVerticalSplit
nnoremap <silent> <C-X>b :ToggleBufExplorer
nnoremap <C-C>o :TagbarToggle
nnoremap <C-X>o :Unite  -start-insert -no-split outline
map <C-X><C-F> :Dox
nnoremap <C-T> :call NumberToggle()
nmap <M-r> :call ReName()
nmap <M-d> :call DeleteLines()
nmap <M-y> :call CopyLinesToSystem()
nmap <M-c> :call ClearCurrentCursor()
nmap <M-g> :call GetCurrentCursor()
nnoremap <silent> <C-Y> :call context#update('C-Y')
nnoremap <silent> <C-E> :call context#update('C-E')
map <C-X> 
noremap <C-X>z zf%
nmap <C-E>u gUiw
nmap <C-E>i guiw
...
inoremap <silent> <expr> <NL> coc#refresh()
cnoremap <NL> <Down>
cnoremap  <Up>
...
nmap ò :call ReName()
nmap ä :call DeleteLines()
nmap ù :call CopyLinesToSystem()
nmap ã :call ClearCurrentCursor()
nmap ç :call GetCurrentCursor()
inoremap kj 
cmap w!! w !sudo tee > /dev/null %
cnoreabbr st term
cnoreabbr vt vert term
let &cpo=s:cpo_save
unlet s:cpo_save
...
set runtimepath+=~/.vim/bundle/FencView.vim/
...
set runtimepath+=~/.vim/bundle/DoxygenToolkit.vim/
set runtimepath+=~/.vim/bundle/vim-colors-solarized/
set runtimepath+=~/.vim/bundle/molokai/
set runtimepath+=~/.vim/bundle/vim-edit-properties/
set runtimepath+=~/.vim/bundle/JSON.vim/
set runtimepath+=~/.vim/bundle/SQLComplete.vim/
set runtimepath+=~/.vim/bundle/vimproc/
set runtimepath+=~/.vim/bundle/unite.vim/
set runtimepath+=~/.vim/bundle/unite-outline/
set runtimepath+=~/.vim/bundle/tagbar/
set runtimepath+=~/.vim/bundle/supertab/
set runtimepath+=~/.vim/bundle/ctrlsf.vim/
set runtimepath+=~/.vim/bundle/ack.vim/
set runtimepath+=~/.vim/bundle/pangu.vim/
set runtimepath+=~/.vim/bundle/vim-dirdiff/
set runtimepath+=~/.vim/bundle/vim-cmake-syntax/
set runtimepath+=~/.vim/bundle/vim-highlight-cursor-words/
set runtimepath+=~/.vim/bundle/vim-clang-format/
set runtimepath+=~/.vim/bundle/gft4c/
set runtimepath+=~/.vim/bundle/rainbow/
set runtimepath+=~/.vim/bundle/google.vim/
set runtimepath+=~/.vim/bundle/vim-go/
set runtimepath+=~/.vim/bundle/rust.vim/
set runtimepath+=~/.vim/bundle/nnn.vim/
...
set splitbelow
set splitright
set statusline=%{coc#status()}%{get(b:,'coc_current_function','')}%<%f\ %h%m%r%=%k[%{(&fenc==\"\")?&enc:&fenc}%{(&bomb?\",BOM\":\"\")}]\ %-14.(%l,%c%V%)\ %P
set noswapfile
